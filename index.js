...
function createVideoCard(videoTitle , videoThumb){
var cardDiv = document.createElement('div');
cardDiv.classList.add('card');

var cardImg = document.createElement('img');
cardImg.classList.add('cardImg');
cardImg.src = videoThumb;
cardImg.alt = videoTitle;
...
cardHeader.innerText = videoTitle;

var cardText = document.createElement('p');
cardText.classList.add('cardText');
cardText.innerText = videoTitle;
...
for (var i=0; i < cards.length; i++ ){
    var videoCard = createVideoCard(cards[i].cardHeader, cards[i].cardImg);
